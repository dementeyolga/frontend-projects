...
class News {
    draw(data: NewsItem[]): void {
        ...
        const fragment = this.createNewsFragment(news);
    ...
    private createNewsFragment(news: NewsItem[]): DocumentFragment {
        ...
        if (newsItemTemp instanceof HTMLTemplateElement) {
            news.forEach((item, idx) => {
                ...
                if (newsClone instanceof DocumentFragment) {
                    this.fillNewsCard(newsClone, item, idx);
    ...
    private fillNewsCard(newsClone: DocumentFragment, item: NewsItem, idx: number): void {
        ...
        if (newsDescriptionTitle instanceof HTMLHeadingElement) {
            ...
            throw new Error(`Element with selector '.news__description-title' is not of type HTMLHeadingElement`);
        }
        ...
        if (newsDescriptionSource instanceof HTMLHeadingElement) {
            ...
            throw new Error(`Element with selector '.news__description-source' is not of type HTMLHeadingElement`);
        }
        ...
        if (newsDescriptionContent instanceof HTMLParagraphElement) {
            ...
            throw new Error(`Element with selector '.news__description-content' is not of type HTMLParagraphElement`);
        }
        ...
        if (newsReadMoreLink instanceof HTMLAnchorElement) {
            ...
            throw new Error(`Element with selector '.news__read-more a' is not of type HTMLParagraphElement`);
        }
    }
}
